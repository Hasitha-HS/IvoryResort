    ...
    <div className="space-y-8 pb-16">
      ...
      <section id="gallery" className="container">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <figure className="group overflow-hidden rounded-[2rem] border border-[#DED8CF] bg-white/60">
            <img src="/images/images-livingarea.jpeg" alt="Comfortable shared living area at Ivory Resort Anuradhapura" className="h-72 w-full object-cover transition duration-500 group-hover:scale-105" />
          ...
          <figure className="group overflow-hidden rounded-[2rem] border border-[#DED8CF] bg-white/60">
            <img src="/images/images-kitchen.jpeg" alt="Fully equipped kitchen at Ivory Resort Anuradhapura" className="h-72 w-full object-cover transition duration-500 group-hover:scale-105" />
          ...
          <figure className="group overflow-hidden rounded-[2rem] border border-[#DED8CF] bg-white/60 sm:col-span-2 lg:col-span-1">
            <img src="/images/images-garden.jpeg" alt="Green garden area surrounding Ivory Resort Anuradhapura" className="h-72 w-full object-cover transition duration-500 group-hover:scale-105" />
      ...
      <section id="bedrooms" className="container">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <figure className="group overflow-hidden rounded-[2rem] border border-[#DED8CF] bg-white/60">
            <img src="/images/image-bedroom1.jpeg" alt="Private bedroom one at Ivory Resort Anuradhapura" className="h-80 w-full object-cover transition duration-500 group-hover:scale-105" />
          ...
          <figure className="group overflow-hidden rounded-[2rem] border border-[#DED8CF] bg-white/60">
            <img src="/images/images-bedroom2.jpeg" alt="Private bedroom two at Ivory Resort Anuradhapura" className="h-80 w-full object-cover transition duration-500 group-hover:scale-105" />
            <figcaption className="p-5 text-sm text-[#4A4A40]">
